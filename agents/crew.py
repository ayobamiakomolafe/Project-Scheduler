...
def build_crew(project_description):
    ...
    t3 = Task(
        ...
        expected_output="JSON with tasks, filled duration(most be greater than 0), cost, resources, dependencies. JSON must be correctly formatted with no added text.resources should be a list of strings (e.g. [string1, string2])",
        context=[t2],
